...
class Scenario(object):
    ...
    def system_tick(self,dt):
        ...
        self.logger.debug("End system tick, duration: "+str(time.clock()-tick_start))
...
class SeedScenario(Scenario):
    def __init__(self,name='LORKHAN',logger=util.generic_logger):
        ...
        modComp.equipment['nadir5'][3].build_equipment_task(util.equipment_targets['Purifier'])
