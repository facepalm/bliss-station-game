...
class Task(object):
    def __init__(self, name = 'GENERIC TASK', owner = None, assigned_to = None, severity = "LOW", timeout = None, task_duration = 1800, fetch_location_method=None, station=None, logger=None):
        self.owner = owner
